...
# ==============================================================================
"""Converts Mushroom data to TFRecords of TF-Example protos.
...
def _get_filenames_and_classes(dataset_dir):
  ...
  """
  mushroom_root = os.path.join(dataset_dir, '')
  directories = []
  class_names = []
  for filename in os.listdir(mushroom_root):
    path = os.path.join(mushroom_root, filename)
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'mushrooms%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dirs):
  ...
  for dir_index in range(len(dataset_dirs)):
    ...
    _convert_dataset(dataset_type, photo_filenames, class_names_to_ids,dataset_dir)
